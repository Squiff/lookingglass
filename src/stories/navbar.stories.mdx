...
<Meta title="Components/NavBar" component={NavBar} argTypes={stories.argTypes} parameters={stories.parameters} />
...
They have been wrapped in `<Lookingglass padding="2" backgroundColor="primary">` to provide padding
